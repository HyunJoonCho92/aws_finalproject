...
<body>
 <h1> 나의 회원관리 프로그램입니다.(수정-github webhook수정 - 슬랙 연동 수정) </h1>
 <h3>
	 <ul>
 		...
 		<li><a href="<%=request.getContextPath()%>/memberinform">내정보 수정하러 가기</a></li>
 		<li><a href="<%=request.getContextPath()%>/memberdelete">회원탈퇴하기</a></li>
 		<li><a href="<%=request.getContextPath()%>/boardlist">게시판가기</a></li>
	</ul> 
 </h3>
 <% if(session.getAttribute("sessionid") != null){ 
 		out.println("<h1>" + session.getAttribute("sessionid") + "회원님 환영합니다. </h1>");
 	}
 %>
